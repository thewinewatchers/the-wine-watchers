...
,
  "chateau-le-pin": {
    ...
    introduction:"Château Le Pin est l'un des domaines les plus confidentiels de Pomerol. Sa production extrêmement limitée, son approche artisanale et la qualité de son terroir en font l'un des vins les plus recherchés au monde. Chaque millésime privilégie la précision, la richesse et l'expression la plus pure du Merlot.",
    sections:[
      {title:"Une histoire récente devenue mythique",paragraphs:[
      ...
      {title:"Un terroir privilégié de Pomerol",paragraphs:[
      ...
      {title:"Le Merlot comme signature",paragraphs:[
      ...
      {title:"Une production confidentielle",paragraphs:[
      ...
      {title:"Un style recherchant l'émotion",paragraphs:[
    ...
    conclusion:"Choisir un millésime de Château Le Pin, c'est découvrir un vin d'une rareté exceptionnelle où la précision du terroir et le travail artisanal donnent naissance à l'une des cuvées les plus emblématiques de Pomerol."
  }
...
,
  "chateau-palmer": {
    ...
    introduction:"Troisième Grand Cru Classé en 1855, Château Palmer s'est forgé une réputation dépassant largement son rang officiel. Son style associe richesse, finesse et profondeur grâce à un terroir exceptionnel et à une forte proportion de Merlot, rare dans le Médoc.",
    sections:[
      {title:"Un domaine emblématique de Margaux",paragraphs:[
      ...
      {title:"Un terroir de graves d'exception",paragraphs:[
      ...
      {title:"Le Merlot, signature du domaine",paragraphs:[
      ...
      {title:"Un style raffiné et profond",paragraphs:[
      ...
      {title:"Alter Ego de Palmer",paragraphs:[
    ...
    conclusion:"Choisir un millésime de Château Palmer, c'est découvrir l'une des expressions les plus élégantes de Margaux, où la finesse s'allie à une remarquable profondeur."
  }
...
,
  "chateau-pichon-comtesse-de-lalande": {
    ...
    sections:[
      ...
      {title:"Des terroirs complémentaires",paragraphs:[
      ...
      {title:"Une signature élégante",paragraphs:[
      ...
      {title:"Une remarquable capacité de garde",paragraphs:[
      ...
      {title:"Réserve de la Comtesse",paragraphs:[
    ...
    conclusion:"Choisir un millésime de Château Pichon Comtesse de Lalande, c'est découvrir un grand Pauillac où la finesse et la profondeur s'expriment avec une remarquable délicatesse."
  }
...
,
  "chateau-pontet-canet": {
    ...
    introduction:"Cinquième Grand Cru Classé en 1855, Château Pontet-Canet s'est imposé comme l'une des propriétés les plus innovantes de Bordeaux. Son engagement précoce en biodynamie, allié à un terroir exceptionnel de graves, donne naissance à des vins profonds, précis et d'une remarquable énergie.",
    sections:[
      {title:"Une propriété historique en constante évolution",paragraphs:[
      ...
      {title:"Un terroir de graves remarquable",paragraphs:[
      ...
      {title:"La biodynamie au service du terroir",paragraphs:[
      ...
      {title:"Un style profond et énergique",paragraphs:[
      ...
      {title:"Une garde remarquable",paragraphs:[
    ...
    conclusion:"Choisir un millésime de Château Pontet-Canet, c'est découvrir un grand Pauillac où tradition, innovation et respect du terroir s'unissent pour produire des vins d'une remarquable précision."
  }
...
,
  "chateau-grand-puy-lacoste": {
    ...
    introduction:"Cinquième Grand Cru Classé en 1855, Château Grand-Puy-Lacoste est reconnu pour son style classique, précis et remarquablement régulier. Son vignoble d'un seul tenant, implanté sur de profondes graves, donne naissance à des vins élégants, structurés et bâtis pour une longue garde.",
    sections:[
      {title:"Une propriété historique de Pauillac",paragraphs:[
      ...
      {title:"Un vignoble remarquablement homogène",paragraphs:[
      ...
      {title:"Un style classique et intemporel",paragraphs:[
      ...
      {title:"Une remarquable aptitude au vieillissement",paragraphs:[
      ...
      {title:"Lacoste-Borie",paragraphs:[
    ...
    conclusion:"Choisir un millésime de Château Grand-Puy-Lacoste, c'est découvrir un Pauillac classique où l'élégance, la précision et la longévité s'expriment avec une remarquable régularité."
  }
...
,
  "chateau-haut-batailley": {
    ...
    introduction:"Cinquième Grand Cru Classé en 1855, Château Haut-Batailley représente l'une des expressions les plus raffinées de Pauillac. Son vignoble de graves profondes, associé à une vinification attentive, donne naissance à des vins équilibrés, précis et dotés d'un excellent potentiel de vieillissement.",
    sections:[
      {title:"Une histoire intimement liée à Batailley",paragraphs:[
      ...
      {title:"Des graves favorables au Cabernet Sauvignon",paragraphs:[
      ...
      {title:"Un style élégant et structuré",paragraphs:[
      ...
      {title:"Une évolution harmonieuse",paragraphs:[
      ...
      {title:"Une signature classique de Pauillac",paragraphs:[
    ...
    conclusion:"Choisir un millésime de Château Haut-Batailley, c'est découvrir un Pauillac élégant, précis et construit pour évoluer harmonieusement au fil des décennies."
  }
...
,
  "chateau-d-armailhac": {
    ...
    introduction:"Cinquième Grand Cru Classé en 1855, Château d'Armailhac appartient à la famille Rothschild depuis 1933. Son vignoble de graves profondes produit des vins qui expriment avec fidélité le caractère de Pauillac : structure, fraîcheur, précision et aptitude au vieillissement.",
    sections:[
      {title:"Un domaine chargé d'histoire",paragraphs:[
      ...
      {title:"Les terroirs de graves de Pauillac",paragraphs:[
      ...
      {title:"Une signature fidèle à Pauillac",paragraphs:[
      ...
      {title:"Une belle capacité de garde",paragraphs:[
      ...
      {title:"Une propriété complémentaire des grands Pauillac Rothschild",paragraphs:[
    ...
    conclusion:"Choisir un millésime de Château d'Armailhac, c'est découvrir un Pauillac authentique où tradition, précision et élégance s'expriment avec constance."
  }

,
  "chateau-leoville-las-cases": {
    eyebrow:"Histoire, terroir et identité",
    title:"Château Léoville Las Cases, la grandeur intemporelle de Saint-Julien",
    introduction:"Deuxième Grand Cru Classé en 1855, Château Léoville Las Cases est considéré comme l'une des références absolues du Médoc. Son terroir exceptionnel, voisin immédiat de Pauillac, donne naissance à des vins d'une profondeur remarquable, alliant puissance, précision et extraordinaire potentiel de garde.",
    sections:[
      {title:"Un héritage historique prestigieux",paragraphs:[
      ...
      {title:"Le Grand Clos de Léoville",paragraphs:[
      ...
      {title:"Une signature de puissance maîtrisée",paragraphs:[
      ...
      {title:"Un immense vin de garde",paragraphs:[
      ...
      {title:"Le Petit Lion et Clos du Marquis",paragraphs:[
    ...
    conclusion:"Choisir un millésime de Château Léoville Las Cases, c'est découvrir l'un des plus grands vins de Bordeaux, où puissance, précision et longévité atteignent un équilibre exceptionnel."
  }
...
,
  "chateau-leoville-barton": {
    ...
    introduction:"Deuxième Grand Cru Classé en 1855, Château Léoville Barton incarne l'expression la plus traditionnelle de Saint-Julien. Resté entre les mains de la famille Barton depuis le XIXᵉ siècle, le domaine est reconnu pour la régularité de ses vins, leur profondeur et leur remarquable potentiel de vieillissement.",
    sections:[
      {title:"Une propriété familiale historique",paragraphs:[
      ...
      {title:"Un terroir de graves exceptionnel",paragraphs:[
      ...
      {title:"Une signature de précision",paragraphs:[
      ...
      {title:"Un style fidèle à Saint-Julien",paragraphs:[
    ...
    conclusion:"Choisir un millésime de Château Léoville Barton, c'est découvrir un grand Saint-Julien où tradition, précision et longévité s'expriment avec une remarquable constance."
  }

,
  "chateau-leoville-poyferre": {
    eyebrow:"Histoire, terroir et identité",
    title:"Château Léoville Poyferré, la profondeur contemporaine de Saint-Julien",
    introduction:"Deuxième Grand Cru Classé en 1855, Château Léoville Poyferré s'est imposé parmi les grandes références de Saint-Julien grâce à des vins profonds, généreux et remarquablement équilibrés. Son style associe la puissance caractéristique du Cabernet Sauvignon à une texture soyeuse et à une grande richesse aromatique.",
    sections:[
      {title:"Un héritage prestigieux",paragraphs:[
      ...
      {title:"Un terroir remarquable de Saint-Julien",paragraphs:[
      ...
      {title:"Un style riche et élégant",paragraphs:[
      ...
      {title:"Une grande aptitude au vieillissement",paragraphs:[
      ...
      {title:"Une signature moderne de Saint-Julien",paragraphs:[
    ...
    conclusion:"Choisir un millésime de Château Léoville Poyferré, c'est découvrir un grand Saint-Julien où puissance, raffinement et profondeur s'unissent dans un remarquable équilibre."
  }
...
,
  "chateau-ducru-beaucaillou": {
    ...
    introduction:"Deuxième Grand Cru Classé en 1855, Château Ducru-Beaucaillou figure parmi les plus grandes références de Saint-Julien. Son nom, issu des « beaux cailloux » de graves qui couvrent son vignoble, résume parfaitement l'origine de son style : une alliance de puissance, de finesse et de précision minérale portée par un terroir exceptionnel.",
    sections:[
      {title:"Un domaine emblématique",paragraphs:[
      ...
      {title:"Les célèbres « beaux cailloux »",paragraphs:[
      ...
      {title:"Une signature raffinée",paragraphs:[
      ...
      {title:"La Croix Ducru-Beaucaillou",paragraphs:[
    ...
    conclusion:"Choisir un millésime de Château Ducru-Beaucaillou, c'est découvrir un grand Saint-Julien où la finesse des graves rencontre une profondeur et une longévité remarquables."
  }
...
,
  "chateau-gruaud-larose": {
    ...
    introduction:"Deuxième Grand Cru Classé en 1855, Château Gruaud Larose est l'une des propriétés historiques de Saint-Julien. Son style associe profondeur, fraîcheur et élégance grâce à un vaste vignoble de graves et à une philosophie privilégiant l'expression du terroir et la capacité de garde.",
    sections:[
      {title:"Une histoire pluriséculaire",paragraphs:[
      ...
      {title:"Un terroir remarquable",paragraphs:[
      ...
      {title:"Une signature classique de Saint-Julien",paragraphs:[
      ...
      {title:"Une philosophie de transmission",paragraphs:[
    ...
    conclusion:"Choisir un millésime de Château Gruaud Larose, c'est découvrir un grand Saint-Julien où tradition, profondeur et élégance s'expriment avec une remarquable régularité."
  }
...
,
  "chateau-beychevelle": {
    ...
    introduction:"Quatrième Grand Cru Classé en 1855, Château Beychevelle est l'une des propriétés les plus célèbres de Saint-Julien. Son terroir de graves, son histoire et son style raffiné donnent naissance à des vins où la finesse, l'équilibre et la régularité occupent une place essentielle.",
    sections:[
      {title:"Le château au vaisseau",paragraphs:[
      ...
      {title:"Un terroir de graves au cœur de Saint-Julien",paragraphs:[
      ...
      {title:"Une signature d'élégance",paragraphs:[
      ...
      {title:"Une évolution remarquable",paragraphs:[
      ...
      {title:"Amiral de Beychevelle",paragraphs:[
    ...
    conclusion:"Choisir un millésime de Château Beychevelle, c'est découvrir un grand Saint-Julien où tradition, élégance et précision s'expriment avec une remarquable constance."
  }
...
,
  "chateau-branaire-ducru": {
    ...
    introduction:"Quatrième Grand Cru Classé en 1855, Château Branaire-Ducru est reconnu pour son style élégant, précis et remarquablement équilibré. Son vaste vignoble de graves produit des vins où la fraîcheur, la pureté du fruit et la finesse tannique occupent une place essentielle.",
    sections:[
      {title:"Un héritage historique",paragraphs:[
      ...
      {title:"Les graves de Saint-Julien",paragraphs:[
      ...
      {title:"Un style raffiné",paragraphs:[
      ...
      {title:"Une vision d'équilibre",paragraphs:[
    ...
    conclusion:"Choisir un millésime de Château Branaire-Ducru, c'est découvrir un grand Saint-Julien où précision, élégance et équilibre s'expriment avec constance."
  }
...
,
  "chateau-rauzan-segla": {
    ...
    introduction:"Deuxième Grand Cru Classé en 1855, Château Rauzan-Ségla est l'une des propriétés emblématiques de Margaux. Son vignoble de graves profondes produit des vins où la finesse aromatique, la précision des tanins et la profondeur de texture s'expriment avec une remarquable constance.",
    sections:[
      {title:"Un grand nom de Margaux",paragraphs:[
      ...
      {title:"Des terroirs d'une grande diversité",paragraphs:[
      ...
      {title:"La signature Rauzan-Ségla",paragraphs:[
    ...
    conclusion:"Choisir un millésime de Château Rauzan-Ségla, c'est découvrir un grand Margaux où la finesse, la précision et la profondeur s'unissent dans un équilibre remarquable."
  }
...
,
  "chateau-brane-cantenac": {
    ...
    introduction:"Deuxième Grand Cru Classé en 1855, Château Brane-Cantenac est l'une des références historiques de Margaux. Son vignoble, situé sur le célèbre plateau de Brane, donne naissance à des vins d'une grande précision, où la finesse aromatique, l'énergie et la profondeur s'équilibrent avec naturel.",
    sections:[
      {title:"Une propriété emblématique",paragraphs:[
      ...
      {title:"Le plateau de Brane",paragraphs:[
      ...
      {title:"Un style tout en élégance",paragraphs:[
      ...
      {title:"Baron de Brane",paragraphs:[
    ...
    conclusion:"Choisir un millésime de Château Brane-Cantenac, c'est découvrir un grand Margaux où élégance, fraîcheur et précision s'expriment avec une remarquable constance."
  }
...
,
  "chateau-lascombes": {
    ...
    introduction:"Deuxième Grand Cru Classé en 1855, Château Lascombes est l'une des plus vastes propriétés de Margaux. Son vignoble réparti sur plusieurs terroirs complémentaires permet d'élaborer des vins alliant profondeur, richesse aromatique et élégance, dans un style fidèle à l'identité de l'appellation.",
    sections:[
      {title:"Une propriété historique de Margaux",paragraphs:[
      ...
      {title:"Une remarquable diversité de terroirs",paragraphs:[
      ...
      {title:"Une signature généreuse et raffinée",paragraphs:[
      ...
      {title:"Une belle aptitude au vieillissement",paragraphs:[
      ...
      {title:"Chevalier de Lascombes",paragraphs:[
    ...
    conclusion:"Choisir un millésime de Château Lascombes, c'est découvrir un grand Margaux où profondeur, générosité et élégance s'expriment avec une remarquable régularité."
  }

,
  "chateau-la-mission-haut-brion": {
    eyebrow:"Histoire, terroir et identité",
    title:"Château La Mission Haut-Brion, la puissance raffinée de Pessac-Léognan",
    introduction:"Classé Cru Classé de Graves, Château La Mission Haut-Brion figure parmi les plus grands vins de Bordeaux. Voisin immédiat de Château Haut-Brion, il possède une identité propre, marquée par une profondeur exceptionnelle, une intensité aromatique remarquable et un potentiel de vieillissement parmi les plus élevés de l'appellation.",
    sections:[
      {title:"Une histoire intimement liée à Haut-Brion",paragraphs:[
      ...
      {title:"Une signature profonde et complexe",paragraphs:[
      ...
      {title:"Un immense potentiel de garde",paragraphs:[
      ...
      {title:"La Chapelle de La Mission Haut-Brion",paragraphs:[
    ...
    conclusion:"Choisir un millésime de Château La Mission Haut-Brion, c'est découvrir un grand Pessac-Léognan où puissance, complexité et élégance s'expriment avec une remarquable intensité."
  }
...
,
  "chateau-haut-bailly": {
    ...
    introduction:"Cru Classé de Graves, Château Haut-Bailly est reconnu comme l'une des références majeures de Pessac-Léognan. Son style repose sur un terroir de graves anciennes, une remarquable finesse tannique et une capacité de vieillissement qui en fait l'un des grands vins de Bordeaux les plus recherchés.",
    sections:[
      {title:"Une propriété historique",paragraphs:[
      ...
      {title:"Un terroir de graves anciennes",paragraphs:[
      ...
      {title:"Une signature d'une grande finesse",paragraphs:[
      ...
      {title:"Haut-Bailly II",paragraphs:[
    ...
    conclusion:"Choisir un millésime de Château Haut-Bailly, c'est découvrir un grand Pessac-Léognan où élégance, précision et profondeur s'expriment avec une remarquable harmonie."
  }

,
  "chateau-les-carmes-haut-brion": {
    eyebrow:"Histoire, terroir et identité",
    title:"Château Les Carmes Haut-Brion, l'expression contemporaine de Pessac-Léognan",
    ...
    sections:[
      ...
      {title:"Un terroir rare au cœur de Bordeaux",paragraphs:[
      ...
      {title:"Le Cabernet Franc comme signature",paragraphs:[
      ...
      {title:"Une vinification tournée vers la précision",paragraphs:[
      ...
      {title:"Une nouvelle référence de Pessac-Léognan",paragraphs:[
    ...
    conclusion:"Choisir un millésime de Château Les Carmes Haut-Brion, c'est découvrir un grand Pessac-Léognan où précision, élégance et originalité s'unissent pour offrir l'une des expressions les plus singulières de Bordeaux."
  }

,
  "chateau-smith-haut-lafitte": {
    eyebrow:"Histoire, terroir et identité",
    title:"Château Smith Haut Lafitte, l'excellence contemporaine de Pessac-Léognan",
    introduction:"Cru Classé de Graves, Château Smith Haut Lafitte s'est imposé comme l'une des références incontournables de Pessac-Léognan. Son vignoble de graves, son engagement environnemental et sa recherche constante de précision donnent naissance à des vins rouges et blancs parmi les plus réputés de Bordeaux.",
    sections:[
      {title:"Une propriété historique tournée vers l'avenir",paragraphs:[
      ...
      {title:"Une philosophie de précision et de respect du vivant",paragraphs:[
      ...
      {title:"Une signature élégante et profonde",paragraphs:[
      ...
      {title:"Les Hauts de Smith",paragraphs:[
    ...
    conclusion:"Choisir un millésime de Château Smith Haut Lafitte, c'est découvrir un grand Pessac-Léognan où tradition, innovation et respect du terroir s'unissent pour produire des vins d'une remarquable élégance."
  }
...
,
  "chateau-pape-clement": {
    ...
    introduction:"Cru Classé de Graves, Château Pape Clément est l'une des propriétés historiques de Pessac-Léognan. Son vignoble, cultivé depuis le XIIIᵉ siècle, donne naissance à des vins rouges et blancs d'une grande profondeur, où richesse, fraîcheur et élégance se conjuguent avec une remarquable constance.",
    sections:[
      {title:"Un héritage exceptionnel",paragraphs:[
      ...
      {title:"Un terroir de graves emblématique",paragraphs:[
      ...
      {title:"Une signature riche et raffinée",paragraphs:[
      ...
      {title:"Le second vin",paragraphs:[
    ...
    conclusion:"Choisir un millésime de Château Pape Clément, c'est découvrir un grand Pessac-Léognan où histoire, précision et profondeur s'expriment avec une remarquable élégance."
  }
...
,
  "domaine-de-chevalier": {
    ...
    introduction:"Cru Classé de Graves, Domaine de Chevalier est l'une des propriétés les plus respectées de Pessac-Léognan. Niché au cœur d'une vaste forêt, le domaine produit des vins rouges et blancs d'une grande précision, reconnus pour leur élégance, leur fraîcheur et leur remarquable aptitude au vieillissement.",
    sections:[
      {title:"Un domaine historique au cœur des Graves",paragraphs:[
      ...
      {title:"Une signature fondée sur la précision",paragraphs:[
      ...
      {title:"Une élégance qui traverse le temps",paragraphs:[
      ...
      {title:"L'Esprit de Chevalier",paragraphs:[
    ...
    conclusion:"Choisir un millésime du Domaine de Chevalier, c'est découvrir un grand Pessac-Léognan où précision, fraîcheur et élégance s'expriment avec une remarquable constance, aussi bien en rouge qu'en blanc."
  }
...
,
  "chateau-la-conseillante": {
    ...
    sections:[
      ...
      {title:"Un terroir au cœur du plateau de Pomerol",paragraphs:[
      ...
      {title:"Merlot et Cabernet Franc en parfaite harmonie",paragraphs:[
      ...
      {title:"Une garde exceptionnelle",paragraphs:[
    ...
    conclusion:"Choisir un millésime de Château La Conseillante, c'est découvrir l'une des expressions les plus élégantes de Pomerol, où profondeur, finesse et harmonie s'unissent dans un équilibre remarquable."
  }
...
,
  "chateau-l-evangile": {
    ...
    introduction:"Château L'Évangile compte parmi les grandes références de Pomerol. Situé entre Petrus et Cheval Blanc, son vignoble bénéficie d'un terroir exceptionnel où les argiles et les graves donnent naissance à des vins profonds, précis et remarquablement équilibrés.",
    sections:[
      {title:"Un domaine historique de Pomerol",paragraphs:[
      ...
      {title:"Un terroir privilégié",paragraphs:[
      ...
      {title:"Merlot et Cabernet Franc",paragraphs:[
      ...
      {title:"Une garde de très haut niveau",paragraphs:[
        "Les meilleurs millésimes évoluent harmonieusement pendant plusieurs décennies.",
        "Le temps renforce leur complexité sans jamais altérer leur fraîcheur naturelle."
      ]}
    ],
    conclusion:"Choisir un millésime de Château L'Évangile, c'est découvrir un grand Pomerol où profondeur, élégance et précision traduisent avec fidélité l'un des plus beaux terroirs de la rive droite."
  }
...
,
  "vieux-chateau-certan": {
    ...
    sections:[
      ...
      {title:"Un terroir exceptionnel",paragraphs:[
      ...
      {title:"Merlot, Cabernet Franc et Cabernet Sauvignon",paragraphs:[
      ...
      {title:"Une signature d'une grande élégance",paragraphs:[
      ...
      {title:"Une référence des grands Pomerol",paragraphs:[
    ...
    conclusion:"Choisir un millésime de Vieux Château Certan, c'est découvrir un grand Pomerol où profondeur, harmonie et élégance traduisent avec fidélité l'un des plus beaux terroirs de la rive droite."
  }
...
,
  "chateau-trotanoy": {
    ...
    introduction:"Château Trotanoy est l'une des propriétés les plus prestigieuses de Pomerol. Son terroir exceptionnel, dominé par des argiles profondes, donne naissance à des vins d'une rare intensité, réputés pour leur structure, leur profondeur et leur extraordinaire potentiel de vieillissement.",
    sections:[
      {title:"Une propriété historique",paragraphs:[
      ...
      {title:"Un terroir d'argiles exceptionnel",paragraphs:[
      ...
      {title:"Une expression unique du Merlot",paragraphs:[
      ...
      {title:"Une signature puissante et raffinée",paragraphs:[
      ...
      {title:"Une référence incontournable de Pomerol",paragraphs:[
    ...
    conclusion:"Choisir un millésime de Château Trotanoy, c'est découvrir un grand Pomerol où puissance, profondeur et élégance traduisent avec fidélité l'un des plus grands terroirs de l'appellation."
  }
...
,
  "chateau-hosanna": {
    ...
    introduction:"Château Hosanna est l'une des propriétés les plus prestigieuses de Pomerol. Né de la réunion de parcelles historiques, le domaine s'est rapidement imposé parmi les grandes références de l'appellation grâce à des vins profonds, raffinés et remarquablement équilibrés, où le Merlot et le Cabernet Franc expriment toute la richesse du terroir.",
    sections:[
      {title:"Une propriété récente sur un terroir historique",paragraphs:[
      ...
      {title:"Un terroir d'argiles et de graves",paragraphs:[
      ...
      {title:"Merlot et Cabernet Franc en harmonie",paragraphs:[
      ...
      {title:"Un grand vin de garde",paragraphs:[
        "Les meilleurs millésimes évoluent harmonieusement pendant plusieurs décennies.",
    ...
    conclusion:"Choisir un millésime de Château Hosanna, c'est découvrir un grand Pomerol où profondeur, finesse et précision traduisent avec élégance la richesse de l'un des plus beaux terroirs de la rive droite."
  }
...
,
  "chateau-la-fleur-petrus": {
    ...
    introduction:"Château La Fleur-Pétrus compte parmi les grandes références de Pomerol. Situé sur le célèbre plateau de l'appellation, le domaine produit des vins d'une grande finesse où le Merlot, soutenu par le Cabernet Franc, exprime toute la richesse d'un terroir exceptionnel.",
    sections:[
      {title:"Une propriété emblématique",paragraphs:[
      ...
      {title:"Un terroir de graves et d'argiles",paragraphs:[
      ...
      {title:"Le style La Fleur-Pétrus",paragraphs:[
      ...
      {title:"Une référence de la rive droite",paragraphs:[
    ...
    conclusion:"Choisir un millésime de Château La Fleur-Pétrus, c'est découvrir un grand Pomerol où profondeur, finesse et équilibre expriment toute la noblesse du plateau de l'appellation."
  }
...
,
  "chateau-l-eglise-clinet": {
    ...
    introduction:"Château L'Église-Clinet figure parmi les domaines les plus prestigieux de Pomerol. Grâce à un terroir exceptionnel et à une recherche constante de précision, la propriété produit des vins d'une remarquable intensité, où profondeur, fraîcheur et élégance se conjuguent avec une rare harmonie.",
    sections:[
      {title:"Une propriété emblématique de Pomerol",paragraphs:[
      ...
      {title:"Merlot et Cabernet Franc en parfaite complémentarité",paragraphs:[
    ...
    conclusion:"Choisir un millésime de Château L'Église-Clinet, c'est découvrir un grand Pomerol où précision, profondeur et élégance expriment avec fidélité l'un des plus beaux terroirs de la rive droite."
  }
...
,
  "chateau-clinet": {
    ...
    introduction:"Château Clinet compte parmi les grandes références de Pomerol. Situé sur le célèbre plateau de l'appellation, le domaine est reconnu pour des vins profonds, généreux et remarquablement équilibrés, où le Merlot exprime toute la richesse de son terroir tout en conservant une remarquable fraîcheur.",
    sections:[
      {title:"Une propriété historique de Pomerol",paragraphs:[
      ...
      {title:"Le Merlot comme fil conducteur",paragraphs:[
      ...
      {title:"Une signature généreuse et élégante",paragraphs:[
    ...
    conclusion:"Choisir un millésime de Château Clinet, c'est découvrir un grand Pomerol où richesse, précision et élégance traduisent avec fidélité la noblesse du plateau de l'appellation."
  }
...
,
  "chateau-la-violette": {
    ...
    sections:[
      ...
      {title:"Le Merlot dans toute sa pureté",paragraphs:[
      ...
      {title:"Une production extrêmement limitée",paragraphs:[
    ...
    conclusion:"Choisir un millésime de Château La Violette, c'est découvrir un grand Pomerol d'une rareté exceptionnelle où profondeur, finesse et élégance expriment toute la richesse d'un terroir unique."
  }
...
,
  "chateau-angelus": {
    ...
    introduction:"Premier Grand Cru Classé A pendant de nombreuses années, Château Angélus est l'une des propriétés emblématiques de Saint-Émilion. Son terroir exceptionnel, où le Cabernet Franc joue un rôle majeur aux côtés du Merlot, donne naissance à des vins profonds, raffinés et dotés d'un remarquable potentiel de garde.",
    sections:[
      {title:"Une propriété historique",paragraphs:[
      ...
      {title:"Un terroir d'exception",paragraphs:[
      ...
      {title:"Le rôle essentiel du Cabernet Franc",paragraphs:[
      ...
      {title:"Une signature intense et élégante",paragraphs:[
      ...
      {title:"Carillon d'Angélus",paragraphs:[
    ...
    conclusion:"Choisir un millésime de Château Angélus, c'est découvrir un grand Saint-Émilion où puissance, élégance et précision traduisent toute la richesse d'un terroir exceptionnel."
  }
...
,
  "chateau-figeac": {
    ...
    introduction:"Premier Grand Cru Classé A, Château Figeac occupe une place à part dans le paysage de Saint-Émilion. Son vaste terroir de graves et son assemblage dominé par les Cabernets lui confèrent un style unique, alliant finesse, fraîcheur, profondeur et exceptionnelle capacité de vieillissement.",
    sections:[
      {title:"Un domaine historique",paragraphs:[
      ...
      {title:"Un terroir de graves rare à Saint-Émilion",paragraphs:[
      ...
      {title:"Les Cabernets comme signature",paragraphs:[
      ...
      {title:"Une élégance intemporelle",paragraphs:[
    ...
    conclusion:"Choisir un millésime de Château Figeac, c'est découvrir un grand Saint-Émilion où la fraîcheur des Cabernets, la profondeur du terroir et l'élégance de la rive droite s'unissent dans un équilibre remarquable."
  }
...
,
  "chateau-canon": {
    ...
    introduction:"Premier Grand Cru Classé B, Château Canon figure parmi les références majeures de Saint-Émilion. Implanté sur le célèbre plateau calcaire, le domaine produit des vins où la précision, la fraîcheur et la profondeur s'équilibrent avec une remarquable élégance. Son identité repose sur l'alliance du Merlot et du Cabernet Franc, révélant toute la finesse de ce terroir d'exception.",
    sections:[
      {title:"Une propriété historique",paragraphs:[
      ...
      {title:"Le plateau calcaire de Saint-Émilion",paragraphs:[
      ...
      {title:"Merlot et Cabernet Franc en équilibre",paragraphs:[
    ...
    conclusion:"Choisir un millésime de Château Canon, c'est découvrir un grand Saint-Émilion où la noblesse du plateau calcaire s'exprime à travers des vins d'une remarquable finesse, d'une grande profondeur et d'un exceptionnel potentiel de garde."
  }

,
  "chateau-belair-monange": {
    eyebrow:"Histoire, terroir et identité",
    title:"Château Bélair-Monange, la noblesse du plateau calcaire de Saint-Émilion",
    introduction:"Premier Grand Cru Classé B, Château Bélair-Monange est l'une des grandes propriétés historiques de Saint-Émilion. Situé sur le célèbre plateau calcaire, le domaine produit des vins où la pureté du fruit, la fraîcheur minérale et la profondeur s'unissent dans un équilibre remarquable. Son style allie la richesse du Merlot à l'élégance du Cabernet Franc.",
    sections:[
      {title:"Une propriété au riche héritage",paragraphs:[
      ...
      {title:"Une signature racée",paragraphs:[
    ...
    conclusion:"Choisir un millésime de Château Bélair-Monange, c'est découvrir un grand Saint-Émilion où la finesse du plateau calcaire, la profondeur du Merlot et la fraîcheur du Cabernet Franc s'expriment avec une remarquable élégance."
  }
...
,
  "chateau-pavie": {
    ...
    introduction:"Premier Grand Cru Classé A pendant de nombreuses années, Château Pavie domine le coteau sud-est de Saint-Émilion depuis un terroir exceptionnel. Son vignoble, composé de calcaires, d'argiles et d'éboulis, donne naissance à des vins profonds, concentrés et remarquablement aptes au vieillissement, tout en conservant une grande précision.",
    sections:[
      {title:"Une propriété emblématique",paragraphs:[
      ...
      {title:"Une signature profonde et précise",paragraphs:[
      ...
      {title:"Un très grand potentiel de garde",paragraphs:[
        "Les meilleurs millésimes évoluent harmonieusement pendant plusieurs décennies.",
      ...
      {title:"Arômes de Pavie",paragraphs:[
    ...
    conclusion:"Choisir un millésime de Château Pavie, c'est découvrir un grand Saint-Émilion où puissance, profondeur et élégance traduisent avec fidélité la richesse d'un terroir parmi les plus prestigieux de Bordeaux."
  }
...
,
  "chateau-troplong-mondot": {
    ...
    introduction:"Premier Grand Cru Classé B, Château Troplong Mondot domine l'un des points culminants de Saint-Émilion. Son vaste terroir argilo-calcaire produit des vins profonds, complexes et d'une remarquable fraîcheur, où la puissance s'exprime toujours avec précision et équilibre.",
    sections:[
      {title:"Une propriété emblématique",paragraphs:[
      ...
      {title:"Un terroir d'altitude exceptionnel",paragraphs:[
      ...
      {title:"Une signature profonde et élégante",paragraphs:[
    ...
    conclusion:"Choisir un millésime de Château Troplong Mondot, c'est découvrir un grand Saint-Émilion où puissance, fraîcheur et élégance traduisent toute la noblesse du plateau calcaire."
  }
...
,
  "clos-fourtet": {
    ...
    introduction:"Premier Grand Cru Classé B, Clos Fourtet est l'une des propriétés emblématiques de Saint-Émilion. Entièrement ceint de murs, ce clos historique repose sur le plateau calcaire de l'appellation et produit des vins où fraîcheur, profondeur et finesse s'expriment avec une remarquable régularité.",
    sections:[
      {title:"Un clos chargé d'histoire",paragraphs:[
      ...
      {title:"Le plateau calcaire",paragraphs:[
    ...
    conclusion:"Choisir un millésime de Clos Fourtet, c'est découvrir un grand Saint-Émilion où la noblesse du plateau calcaire s'exprime à travers des vins profonds, précis et d'une élégance intemporelle."
  }

,
  "chateau-quintus": {
    eyebrow:"Histoire, terroir et identité",
    title:"Château Quintus, la nouvelle référence des hauteurs de Saint-Émilion",
    introduction:"Premier Grand Cru Classé de Saint-Émilion, Château Quintus est né de la réunion de plusieurs propriétés historiques situées sur un vaste promontoire calcaire. Son terroir remarquable et une approche parcellaire exigeante donnent naissance à des vins profonds, précis et élégants, fidèles à l'identité de la rive droite.",
    sections:[
      {title:"Une propriété tournée vers l'avenir",paragraphs:[
      ...
      {title:"Un terroir de plateau et de coteaux",paragraphs:[
      ...
      {title:"Le Merlot au cœur de l'assemblage",paragraphs:[
      ...
      {title:"Le Dragon de Quintus",paragraphs:[
    ...
    conclusion:"Choisir un millésime de Château Quintus, c'est découvrir un grand Saint-Émilion où la précision du travail parcellaire, la richesse du Merlot et la fraîcheur des terroirs calcaires s'unissent dans un équilibre remarquable."
  }
...
,
  "chateau-valandraud": {
    ...
    introduction:"Premier Grand Cru Classé de Saint-Émilion, Château Valandraud a profondément marqué l'histoire moderne de Bordeaux. Créé à la fin des années 1980 par Jean-Luc Thunevin et Murielle Andraud, le domaine a démontré qu'une petite propriété pouvait rivaliser avec les plus grands crus grâce à une sélection extrêmement rigoureuse, des rendements maîtrisés et une recherche constante de qualité.",
    sections:[
      {title:"Une aventure devenue légendaire",paragraphs:[
      ...
      {title:"Des terroirs sélectionnés avec précision",paragraphs:[
      ...
      {title:"Une signature moderne et élégante",paragraphs:[
      ...
      {title:"Virginie de Valandraud",paragraphs:[
    ...
    conclusion:"Choisir un millésime de Château Valandraud, c'est découvrir un grand Saint-Émilion qui a profondément marqué l'histoire contemporaine de Bordeaux en associant innovation, exigence et expression fidèle du terroir."
  }

,
  "domaine-de-la-romanee-conti": {
    eyebrow:"Histoire, terroir et identité",
    title:"Domaine de la Romanée-Conti, la quintessence des grands vins de Bourgogne",
    introduction:"Le Domaine de la Romanée-Conti, souvent désigné par les initiales DRC, occupe une place unique dans l'univers des grands vins. Installé à Vosne-Romanée, il exploite certains des climats les plus prestigieux de Bourgogne et produit des vins d'une rare intensité, recherchés pour leur précision, leur profondeur et leur capacité exceptionnelle à traduire l'identité de chaque terroir.",
    sections:[
      {title:"Un domaine au cœur de l'histoire bourguignonne",paragraphs:[
      ...
      {title:"Des grands crus d'exception",paragraphs:[
      ...
      {title:"Le Pinot Noir dans sa forme la plus pure",paragraphs:[
      ...
      {title:"Une viticulture exigeante",paragraphs:[
      ...
      {title:"Une rareté devenue légendaire",paragraphs:[
    ...
    conclusion:"Choisir un millésime du Domaine de la Romanée-Conti, c'est découvrir l'une des expressions les plus accomplies du Pinot Noir et des grands terroirs bourguignons, où précision, profondeur et émotion se rejoignent dans des vins d'une rare singularité."
  }

,
  "armand-rousseau": {
    eyebrow:"Histoire, terroir et identité",
    title:"Domaine Armand Rousseau, la noblesse du Pinot Noir à Gevrey-Chambertin",
    introduction:"Le Domaine Armand Rousseau est l'une des références absolues de la Côte de Nuits. Installé à Gevrey-Chambertin, il exploite plusieurs des plus grands climats de Bourgogne et produit des vins recherchés pour leur profondeur, leur finesse et leur capacité exceptionnelle à traduire l'identité de chaque terroir.",
    sections:[
      {title:"Une histoire familiale emblématique",paragraphs:[
      ...
      {title:"Des grands crus parmi les plus prestigieux",paragraphs:[
      ...
      {title:"Le style Armand Rousseau",paragraphs:[
      ...
      {title:"Une vinification au service du terroir",paragraphs:[
      ...
      {title:"Une rareté recherchée dans le monde entier",paragraphs:[
    ...
    conclusion:"Choisir un millésime du Domaine Armand Rousseau, c'est découvrir l'une des expressions les plus nobles du Pinot Noir bourguignon, où finesse, profondeur et précision révèlent toute la grandeur des terroirs de la Côte de Nuits."
  }

,
  "domaine-trapet-pere-et-fils": {
    eyebrow:"Histoire, terroir et identité",
    title:"Domaine Trapet Père & Fils, l'expression authentique de Gevrey-Chambertin",
    introduction:"Le Domaine Trapet Père & Fils fait partie des grandes signatures de la Côte de Nuits. Installé à Gevrey-Chambertin, il est reconnu pour son approche exigeante de la viticulture, son respect du terroir et des vins d'une grande finesse, où le Pinot Noir exprime avec précision toute la personnalité des grands climats bourguignons.",
    sections:[
      {title:"Une longue tradition familiale",paragraphs:[
      ...
      {title:"Des grands crus prestigieux",paragraphs:[
      ...
      {title:"Une viticulture respectueuse",paragraphs:[
      ...
      {title:"Le style Trapet",paragraphs:[
    ...
    conclusion:"Choisir un millésime du Domaine Trapet Père & Fils, c'est découvrir une interprétation authentique des grands terroirs de Gevrey-Chambertin, où élégance, précision et respect du vivant s'unissent dans des vins d'une remarquable personnalité."
  }
...
,
  "domaine-comte-georges-de-vogue": {
    ...
    introduction:"Le Domaine Comte Georges de Vogüé figure parmi les propriétés les plus prestigieuses de Bourgogne. Installé à Chambolle-Musigny depuis plusieurs siècles, il possède quelques-uns des plus grands climats de la Côte de Nuits, dont une part majeure du mythique Bonnes-Mares ainsi que le célèbre Musigny Grand Cru. Ses vins incarnent la finesse, la profondeur et l'élégance les plus accomplies du Pinot Noir bourguignon.",
    sections:[
      {title:"Une histoire familiale exceptionnelle",paragraphs:[
      ...
      {title:"Des terroirs parmi les plus prestigieux",paragraphs:[
      ...
      {title:"Le style Comte Georges de Vogüé",paragraphs:[
      ...
      {title:"Une vinification au service des climats",paragraphs:[
      ...
      {title:"Des vins de très grande garde",paragraphs:[
    ...
    conclusion:"Choisir un millésime du Domaine Comte Georges de Vogüé, c'est découvrir l'une des expressions les plus raffinées du Pinot Noir, où l'élégance de Chambolle-Musigny et la grandeur de Musigny et Bonnes-Mares atteignent un niveau d'excellence reconnu dans le monde entier."
  }

,
  "domaine-leroy": {
    eyebrow:"Histoire, terroir et identité",
    title:"Domaine Leroy, l'expression absolue des grands terroirs de Bourgogne",
    introduction:"Le Domaine Leroy occupe une place unique dans l'univers des grands vins de Bourgogne. Sous l'impulsion de Lalou Bize-Leroy, le domaine est devenu une référence mondiale grâce à une viticulture d'une exigence exceptionnelle, des rendements très faibles et une recherche constante de l'expression la plus pure de chaque climat.",
    sections:[
      {title:"Une propriété devenue légendaire",paragraphs:[
      ...
      {title:"Des climats parmi les plus prestigieux",paragraphs:[
      ...
      {title:"Une viticulture d'exception",paragraphs:[
      ...
      {title:"Une signature incomparable",paragraphs:[
      ...
      {title:"Une rareté mondiale",paragraphs:[
    ...
    conclusion:"Choisir un millésime du Domaine Leroy, c'est découvrir l'une des expressions les plus accomplies des grands terroirs bourguignons, où précision, émotion et profondeur atteignent un niveau d'excellence exceptionnel."
  }
...
,
  "domaine-e-rouget": {
    ...
    introduction:"Le Domaine E. Rouget compte parmi les propriétés les plus recherchées de Bourgogne. Installé à Flagey-Échezeaux, il perpétue l'héritage de Henri Jayer, figure légendaire de la viticulture bourguignonne. Ses vins, produits en très faibles quantités, sont réputés pour leur pureté, leur finesse et leur remarquable capacité à exprimer l'identité de chaque climat.",
    sections:[
      {title:"Un héritage unique",paragraphs:[
      ...
      {title:"Des terroirs prestigieux",paragraphs:[
      ...
      {title:"Le style E. Rouget",paragraphs:[
      ...
      {title:"Une vinification respectueuse",paragraphs:[
      ...
      {title:"Une rareté très recherchée",paragraphs:[
    ...
    conclusion:"Choisir un millésime du Domaine E. Rouget, c'est découvrir un Pinot Noir d'une rare élégance, héritier de la tradition de Henri Jayer et fidèle aux plus grands terroirs de la Côte de Nuits."
  }

,
  "domaine-louis-jadot": {
    eyebrow:"Histoire, terroir et identité",
    title:"Domaine Louis Jadot, deux siècles d'excellence au cœur de la Bourgogne",
    introduction:"Fondée en 1859 à Beaune, la Maison Louis Jadot est l'une des signatures les plus prestigieuses de Bourgogne. À la fois propriétaire de domaines d'exception et négociant-éleveur de référence, elle élabore une collection remarquable de vins couvrant l'ensemble des grands terroirs bourguignons, des appellations régionales aux Grands Crus les plus mythiques.",
    sections:[
      {title:"Une maison historique",paragraphs:[
      ...
      {title:"Un patrimoine unique de terroirs",paragraphs:[
      ...
      {title:"Une philosophie de précision",paragraphs:[
      ...
      {title:"Des vins d'une grande élégance",paragraphs:[
    ...
    conclusion:"Choisir un millésime du Domaine Louis Jadot, c'est découvrir une interprétation fidèle des grands terroirs de Bourgogne, où tradition, précision et élégance se retrouvent dans chacune des appellations produites par la maison."
  }

,
  "georges-roumier": {
    eyebrow:"Histoire, terroir et identité",
    title:"Domaine Georges Roumier, l'une des plus grandes signatures de Chambolle-Musigny",
    introduction:"Le Domaine Georges Roumier figure parmi les propriétés les plus prestigieuses de Bourgogne. Fondé en 1924 à Chambolle-Musigny, il est reconnu dans le monde entier pour la finesse de ses Pinot Noir et sa capacité exceptionnelle à révéler la personnalité des plus grands climats de la Côte de Nuits.",
    sections:[
      {title:"Une histoire familiale d'excellence",paragraphs:[
      ...
      {title:"Le style Georges Roumier",paragraphs:[
    ...
    conclusion:"Choisir un millésime du Domaine Georges Roumier, c'est découvrir l'une des expressions les plus raffinées du Pinot Noir bourguignon, où précision, profondeur et élégance traduisent toute la noblesse des grands terroirs de Chambolle-Musigny."
  }
...
,
  "clos-des-lambrays": {
    ...
    introduction:"Le Domaine des Lambrays est l'une des propriétés emblématiques de Morey-Saint-Denis. Autour du mythique Clos des Lambrays Grand Cru, monopole presque intégral du domaine, s'exprime une vision raffinée du Pinot Noir où profondeur, finesse et précision traduisent toute la noblesse de la Côte de Nuits.",
    sections:[
      {title:"Un clos chargé d'histoire",paragraphs:[
      ...
      {title:"Un Grand Cru d'exception",paragraphs:[
      ...
      {title:"Une interprétation fidèle du Pinot Noir",paragraphs:[
      ...
      {title:"Une vinification de précision",paragraphs:[
      ...
      {title:"Une référence de Morey-Saint-Denis",paragraphs:[
    ...
    conclusion:"Choisir un millésime du Domaine des Lambrays, c'est découvrir l'une des expressions les plus accomplies du Pinot Noir bourguignon, où le Clos des Lambrays révèle avec précision toute la richesse des grands terroirs de Morey-Saint-Denis."
  }
...
,
  "clos-de-tart": {
    ...
    sections:[
      ...
      {title:"Un terroir unique",paragraphs:[
      ...
      {title:"Une interprétation magistrale du Pinot Noir",paragraphs:[
      ...
      {title:"Une viticulture de précision",paragraphs:[
    ...
    conclusion:"Choisir un millésime du Clos de Tart, c'est découvrir un Grand Cru mythique où l'histoire, la précision du Pinot Noir et la noblesse des terroirs de Morey-Saint-Denis s'unissent dans l'une des plus grandes expressions de la Bourgogne."
  }
...
,
  "dominio-de-pingus": {
    ...
    sections:[
      ...
      {title:"Des vieilles vignes d'exception",paragraphs:[
      ...
      {title:"Une signature unique",paragraphs:[
      ...
      {title:"Pingus, Flor de Pingus et PSI",paragraphs:[
    ...
    conclusion:"Choisir un millésime de Dominio de Pingus, c'est découvrir l'une des plus grandes expressions contemporaines du Tempranillo, où rareté, profondeur et élégance placent la Ribera del Duero au sommet de la viticulture mondiale."
  }
...
,
  "e-guigal": {
    ...
    introduction:"Fondée en 1946 à Ampuis, la Maison E. Guigal est devenue l'une des références absolues de la Vallée du Rhône. Son nom est indissociable des plus grands terroirs de Côte-Rôtie, notamment La Mouline, La Turque, La Landonne et plus récemment La Reynarde. Chaque cuvée illustre une recherche constante de précision, d'élégance et de longévité.",
    sections:[
      {title:"Une maison familiale de renommée mondiale",paragraphs:[
      ...
      {title:"Les mythiques « La La »",paragraphs:[
      ...
      {title:"La Syrah sublimée",paragraphs:[
      ...
      {title:"Un élevage emblématique",paragraphs:[
      ...
      {title:"Une référence internationale",paragraphs:[
    ...
    conclusion:"Choisir un millésime de la Maison E. Guigal, c'est découvrir l'une des plus grandes expressions de la Syrah et des terroirs de la Vallée du Rhône, où tradition, précision et émotion se retrouvent dans chaque bouteille."
  }
...
,
  "m-chapoutier": {
    ...
    sections:[
      ...
      {title:"Les plus grands terroirs du Rhône",paragraphs:[
      ...
      {title:"Une viticulture pionnière",paragraphs:[
      ...
      {title:"Des vins de caractère",paragraphs:[
    ...
    conclusion:"Choisir un millésime de la Maison M. Chapoutier, c'est découvrir une interprétation authentique des plus grands terroirs rhodaniens, où précision, respect du vivant et émotion donnent naissance à des vins d'une remarquable longévité."
  }
...
,
  "tenuta-san-guido": {
    ...
    sections:[
      ...
      {title:"Un terroir unique face à la mer",paragraphs:[
      ...
      {title:"Sassicaia, Guidalberto et Le Difese",paragraphs:[
      ...
      {title:"Une signature internationale",paragraphs:[
      ...
      {title:"L'une des plus grandes références italiennes",paragraphs:[
    ...
    conclusion:"Choisir un millésime de Tenuta San Guido, c'est découvrir le domaine qui a donné naissance à Sassicaia et ouvert une nouvelle page de l'histoire des grands vins italiens, où élégance, précision et longévité atteignent un niveau d'excellence reconnu dans le monde entier."
  }
...
,
  "tenuta-dell-ornellaia": {
    ...
    sections:[
      ...
      {title:"Le terroir de Bolgheri",paragraphs:[
      ...
      {title:"Ornellaia, Masseto et Le Serre Nuove",paragraphs:[
      ...
      {title:"Une signature d'une remarquable élégance",paragraphs:[
      ...
      {title:"Une référence des Super Toscans",paragraphs:[
    ...
    conclusion:"Choisir un millésime de Tenuta dell'Ornellaia, c'est découvrir l'une des plus belles expressions contemporaines de Bolgheri, où précision, élégance et profondeur font rayonner les grands vins italiens sur la scène internationale."
  }

,
  "opus-one": {
    eyebrow:"Histoire, terroir et identité",
    title:"Opus One, l'alliance des grands savoir-faire de Napa Valley et Bordeaux",
    introduction:"Né de la rencontre entre le Baron Philippe de Rothschild et Robert Mondavi, Opus One est l'un des domaines les plus prestigieux des États-Unis. Situé au cœur de Napa Valley, il associe l'élégance bordelaise à la générosité californienne dans des vins d'une remarquable précision, devenus des références mondiales.",
    sections:[
      {title:"Une collaboration historique",paragraphs:[
      ...
      {title:"Un terroir d'exception à Oakville",paragraphs:[
      ...
      {title:"Les grands cépages bordelais",paragraphs:[
      ...
      {title:"Une icône de Napa Valley",paragraphs:[
    ...
    conclusion:"Choisir un millésime d'Opus One, c'est découvrir l'une des plus grandes réussites de la viticulture contemporaine, où l'élégance inspirée de Bordeaux rencontre la richesse des terroirs de Napa Valley dans un équilibre remarquable."
  }
...
PRODUCER_EDITORIAL_LIBRARY["guigal"] =

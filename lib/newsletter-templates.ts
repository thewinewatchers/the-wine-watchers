...
export const NEWSLETTER_TEMPLATES: NewsletterTemplate[] = [
  {
    ...
    category: "Commercial",
    description: "Mettre en avant une sélection limitée de vins actuellement disponibles.",
    subject: "Les offres du moment chez The Wine Watchers",
    preheader: "Découvrez notre sélection actuelle de grands vins disponibles en quantité limitée.",
  ...
  },
  {
    ...
    name: "Primeurs",
    category: "Bordeaux",
    description: "Présenter une campagne Primeurs et diriger les clients vers la sélection dédiée.",
    subject: "Primeurs : notre sélection de grands Bordeaux",
    preheader: "Accédez à notre sélection de vins de Bordeaux proposés en Primeurs.",
  ...
  },
  {
    ...
    name: "Bordeaux",
    category: "Région",
    description: "Valoriser les grands crus et appellations de Bordeaux.",
    subject: "Bordeaux : une sélection de propriétés incontournables",
    preheader: "Pauillac, Margaux, Saint-Émilion, Pomerol et les grandes appellations bordelaises.",
  ...
  },
  {
    ...
    name: "Bourgogne",
    category: "Région",
    description: "Mettre en avant domaines, climats et grands crus de Bourgogne.",
    subject: "Bourgogne : domaines et grands crus d’exception",
    preheader: "Découvrez notre sélection de grands vins de Bourgogne.",
  ...
  },
  {
    ...
    category: "Région",
    description: "Présenter les cuvées emblématiques de la Vallée du Rhône.",
    subject: "Vallée du Rhône : cuvées emblématiques et grands terroirs",
    preheader: "Côte-Rôtie, Hermitage et grandes signatures rhodaniennes.",
  ...
  },
  {
    ...
    name: "Italie",
    category: "Région",
    description: "Mettre en valeur les grandes signatures italiennes.",
    subject: "Italie : les grandes signatures de notre sélection",
    preheader: "Découvrez notre sélection de vins italiens emblématiques.",
  ...
  },
  {
    ...
    name: "Espagne",
    category: "Région",
    description: "Présenter les domaines et cuvées espagnoles du catalogue.",
    subject: "Espagne : une sélection de vins rares et prestigieux",
    preheader: "Découvrez les grandes cuvées espagnoles disponibles chez The Wine Watchers.",
  ...
  },
  {
    ...
    name: "USA",
    category: "Région",
    description: "Valoriser les grandes cuvées américaines et la Napa Valley.",
    subject: "USA : les grands vins de la Napa Valley",
    preheader: "Découvrez notre sélection de vins américains de prestige.",
  ...
  },
  {
    ...
    name: "Champagne",
    category: "Région",
    description: "Préparer une campagne consacrée aux maisons et cuvées de Champagne.",
    subject: "Champagne : une sélection pour les grandes occasions",
    preheader: "Découvrez notre sélection de champagnes pour célébrer les moments d’exception.",
  ...
  },
  {
    ...
    name: "Foire aux vins",
    category: "Saisonnier",
    description: "Créer une opération commerciale temporaire sur une sélection de vins.",
    subject: "Foire aux vins : notre sélection à découvrir",
    preheader: "Une sélection exceptionnelle disponible pendant une durée limitée.",
  ...
  },
  {
    ...
    name: "Noël",
    category: "Saisonnier",
    description: "Proposer une sélection de bouteilles et coffrets pour les fêtes de Noël.",
    subject: "Noël : offrez un grand vin",
    preheader: "Découvrez notre sélection de bouteilles d’exception pour les fêtes.",
  ...
  },
  {
    ...
    name: "Nouvel An",
    category: "Saisonnier",
    description: "Créer une campagne festive pour le réveillon et la nouvelle année.",
    subject: "Nouvel An : célébrez avec des vins d’exception",
    preheader: "Notre sélection pour accompagner le réveillon et commencer l’année avec élégance.",
...
export function getNewsletterTemplate(templateId: string) {
  return NEWSLETTER_TEMPLATES.find((template) => template.id === templateId);
}